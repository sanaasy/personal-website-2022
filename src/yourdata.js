  ...
  projects: [
    {
      ...
      imageSrc:
        "https://assets.clever.com/resource-icons/apps/5a70a746e8b1d100017d06fa/icon_5d305ed.png",
      url: "",
    },
    {
      title: "30 days of Cloud",
      para:
        "Created a program to help over 1500 students across North America get Google Cloud certifications.",
      imageSrc:
        "https://developers.google.com/community/gdsc/images/stories/csed-week.png",
      url: "https://cloudcoach.dev/home",
    },
    {
      title: "AR/VR Minecraft",
      para:
        "Experimenting with AFrame and Virtual Reality to create an interactive interface.",
      imageSrc: vr,
    ...
    },
    {
      ...
      para:
        "A technique used to study better - 25 minutes study/work, 5 minutes break.",
      imageSrc:
    ...
    },
    {
      ...
      para:
        "Automatically transfer your youtube playlists into your Spotify app.",
      imageSrc:
        "https://cdn.mos.cms.futurecdn.net/bYYiSCS5awcRfhEsFgdoyh-480-80.jpg",
      url: "https://github.com/sanaasy/spotify-automated",
    },
    {
      title: "Blog",
      para:
        "A ruby on rails and react application that allows user to mimic blog functionalities.",
      imageSrc:
